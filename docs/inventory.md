...
| 43 | #/42 | 실습 1 — 정상 경로 최소 모델 | Q1·Q2 | 10 | 검증 | — | 신규. tasks 4단계(Start·User Task 동사·End·Sequence Flow) (리뷰 대기) |
| 44 | #/43 | 실습 2 — 분기와 병렬 판단 | Q3 | 14 | 검증 | — | 신규. lab 판단 슬롯(근무형태 XOR·준비 Parallel·합류 점검) + 교착 caveat (리뷰 대기) |
| 45 | #/44 | 실습 3 — 대기·기한·실패 추가 | Q4·Q5 | 14 | 검증 | — | 신규. tasks 3단계(Wait State·Timer 초과·Retry/Incident) (리뷰 대기) |
| 46 | #/45 | 모델 리뷰 체크리스트 | 전체 | 4 | 검증 | — | 신규(회수), M2. qgrid 6점검(여섯 질문+이름), 상호 리뷰 (리뷰 대기) |
...
- 제작 현황: 대본 1 (01) · 통과 41 (02~42) · 검증 4 (43~46 리뷰 대기) — 제작 46장, 나머지 4장(47~50) 계획. **1~6교시 통과, 7교시(42 통과·43~46 검증) 제작, 8교시 계획.**
