...
| # | reveal | 제목 | 복무 | 분 | 상태 | 출처 | 비고 |
|---|---|---|---|---|---|---|---|
| 47 | #/46 | 실습 4 — 그리지 않을 것 정하기 | Q6 | 18 | 검증 | — | 신규, M5. vs(모델에 남긴다↔모델 밖에 둔다: 알림·검증·입력) + caveat (리뷰 대기) |
| 48 | #/47 | BPMN 적용 판단 기준 | Q6 | 10 | 검증 | — | 신규. matrix(상황×도구: BPMN/Flowchart/State Machine/Checklist), 신규 컴포넌트 (리뷰 대기) |
| 49 | #/48 | 여섯 관점 다시 보기 | 전체 | 12 | 검증 | — | 신규(최종 회수), **M1 화면 확립**. qgrid 여섯 질문(07 북엔드) (리뷰 대기) |
| 50 | #/49 | 내 업무에서 BPMN을 쓰지 않을 곳 | Q6 | 5 | 검증 | — | 신규(클로징), M5. rows 3신호(역할 하나·대기/예외 없음·세부 규칙), 열린 질문 (리뷰 대기) |

## 검산

- 교시별 시간 합(장표 배정 기준): 41 / 44 / 36 / 41 / 42 / 43 / 50 / 45 — 전 교시 50분 이내(잔여는 질문·전환 버퍼).
- 여섯 질문 커버리지: curriculum.md "커버리지 검산" 절과 일치(02는 Q1~Q5 도입부).
- 제작 현황: 대본 1 (01) · 통과 45 (02~46) · 검증 4 (47~50 리뷰 대기) — **제작 50장 완료(01~50)**, 계획 0장. 1~7교시 통과, 8교시(47~50) 제작·리뷰 대기.
