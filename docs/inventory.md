...
| # | reveal | 제목 | 복무 | 분 | 상태 | 출처 | 비고 |
|---|---|---|---|---|---|---|---|
| 22 | #/21 | 토큰 — 진행 위치를 세는 도구 | Q3·Q4 | 7 | 검증 | BPMN 2.0.2·Camunda 7 (§2-3) | 재활용(구 38). cite 추가·역할 notes 보강 (재판정 대기) |
| 23 | #/22 | Gateway의 규칙 — 분기와 합류 | Q3 | 5 | 검증 | — | 신규, M3. frag_gateway_rule.bpmn + s-gateway, beat+caveat (리뷰 대기) |
| 24 | #/23 | Exclusive Gateway — 하나를 고르는 분기와 합류 | Q3 | 9 | 검증 | BPMN 2.0.2·Camunda 7 (§2-2) | 신규(병합). 근무형태 줌 + s-xor(토큰 1·ghost), Default (리뷰 대기) |
| 25 | #/24 | Parallel Gateway — 모두 실행하는 분기와 합류 | Q3 | 9 | 검증 | BPMN 2.0.2·Camunda 7 (§2-3) | 신규(병합). 필수준비 줌 + s-parallel(토큰 1→3→1) (리뷰 대기) |
| 26 | #/25 | XOR 분기와 Parallel 합류의 교착 | Q3 | 7 | 통과 | BPMN 2.0.2·Camunda 7 | 재활용(구 data-plan 35). 재판정 PASS(2026-07-15), 대본 초안 내장 |
| 27 | #/26 | 분기 선택과 토큰 세기 | Q3 | 4 | 검증 | — | 신규(회수). rows(Exclusive·Parallel·교착), 5교시 예고 (리뷰 대기) |
...
| 37 | #/27 | Async·Job·Retry·Incident — 복구 경계 | Q5 | 7 | 통과 | Camunda 7 docs | 재활용(구 data-plan 42). 검증노트 §2-6·7 반영, 재판정 PASS(2026-07-15), 대본 초안 내장 |
...
- 제작 현황: 대본 1 (01) · 통과 21 (02~21·26) · 검증 5 (22~25·27 리뷰 대기·37) — 제작 27장, 나머지 23장 계획. **1·2·3교시 통과, 4교시 22~27 제작.**
