...
| # | reveal | 제목 | 복무 | 분 | 상태 | 출처 | 비고 |
|---|---|---|---|---|---|---|---|
| 35 | #/34 | Process Definition·Instance·Cockpit | Q5·Q4 | 8 | 검증 | Camunda 7 docs (§2-14) | 신규(병합). s-instances(세 건 위치), M4 화면 확립 (리뷰 대기) |
| 36 | #/35 | 저장 지점과 롤백 범위 | Q5 | 6 | 검증 | Camunda 7 docs (§2-8) | 신규. s-savepoint(계정 실패 롤백), asyncBefore (리뷰 대기) |
...
| 38 | #/37 | Boundary Event — 중단과 비중단 | Q5 | 6 | 검증 | BPMN 2.0.2·Camunda 7 (§2-10) | 신규. s-boundary(4시간 비중단 곁길) (리뷰 대기) |
| 39 | #/38 | 업무상 다른 결과와 기술 실패 | Q5 | 6 | 검증 | — | 신규. vs(부적합↔503), 복구는 실행 계층 (리뷰 대기) |
| 40 | #/39 | 채용 취소와 Event Subprocess | Q5 | 6 | 검증 | BPMN 2.0.2·Camunda 7 (§2-15) | 신규. s-eventsub(취소가 전체 중단) (리뷰 대기) |
| 41 | #/40 | 복구 지점 — 저장·재시도·운영 | Q5 | 4 | 검증 | — | 신규(회수), M4. rows 4정리, 7교시 예고 (리뷰 대기) |
...
- 제작 현황: 대본 1 (01) · 통과 34 (02~34·37) · 검증 6 (35·36·38·39·40·41 리뷰 대기) — 제작 40장, 나머지 10장 계획. **1~5교시 통과, 6교시 35~41 제작.**
